...
import ch.hslu.mobpro.coffeetracker.coffee.CoffeeStatisticAndroidTest;
...
@Suite.SuiteClasses({PlayerExperienceServiceAndroidTest.class, PlayerLevelServiceAndroidTest.class, CoffeeDBStorageAndroidTest.class, GPSImplementationAndroidTest.class, CoffeeServiceAndroidTest.class, CoffeeStatisticAndroidTest.class})
